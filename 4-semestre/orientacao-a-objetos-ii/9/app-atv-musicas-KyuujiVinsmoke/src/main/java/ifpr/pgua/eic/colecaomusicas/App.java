...
import ifpr.pgua.eic.colecaomusicas.model.daos.JDBCPlaylistMusicaDAO;
...
public class App extends BaseAppNavigator {
    ...
    private PlaylistMusicaDAO playlistMusicaDAO = new JDBCPlaylistMusicaDAO(FabricaConexoes.getInstance());
    private RepositorioPlaylistMusica repositorioPlayMusicalist = new RepositorioPlaylistMusica(musicaDAO, playlistDAO, playlistMusicaDAO);
    ...
    public void registrarTelas() {
        ...
        registraTela("CADASTRARGENERO",new ScreenRegistryFXML(App.class,"cadastrar_genero.fxml",o->new CadastroGenero(repositorioGeneros)));
        registraTela("LISTARGENEROS",new ScreenRegistryFXML(App.class,"listar_generos.fxml",o->new ListarGeneros(repositorioGeneros)));
        registraTela("CADASTRARARTISTA",new ScreenRegistryFXML(App.class,"cadastrar_artista.fxml",o->new CadastroArtista(repositorioArtistas)));
        registraTela("LISTARARTISTAS",new ScreenRegistryFXML(App.class,"listar_artistas.fxml",o->new ListarArtistas(repositorioArtistas)));
        registraTela("CADASTRARMUSICA",new ScreenRegistryFXML(App.class,"cadastrar_musica.fxml",o->new CadastroMusica(repositorioMusicas,repositorioGeneros,repositorioArtistas)));
        registraTela("LISTARMUSICAS", new ScreenRegistryFXML(App.class,"listar_musicas.fxml",o->new ListarMusicas(repositorioMusicas)));
        registraTela("CADASTRARPLAYLIST",new ScreenRegistryFXML(App.class,"cadastrar_playlist.fxml",o->new CadastroPlaylist(repositorioMusicas, repositorioPlaylist, repositorioPlayMusicalist)));
        registraTela("LISTARPLAYLIST",new ScreenRegistryFXML(App.class,"listar_playlist.fxml",o->new ListarPlaylist(repositorioMusicas, repositorioPlaylist, repositorioPlayMusicalist)));
    }
}