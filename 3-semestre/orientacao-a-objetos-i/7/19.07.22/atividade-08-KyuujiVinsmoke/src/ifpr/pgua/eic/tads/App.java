            ...
            if (opcao == 2) { // Menu da pessoa
                ...
                switch (opcao) {
                    case 1:
                        ...
                        PessoaJuridica pessoaJuridica = banco.buscarPessoaJuridica(documento);

                        if (pessoaFisica != null && op == 1) 
                        {
                        ...
                        else if (pessoaJuridica != null && op == 2) 
                        {
                            System.out.println("Digite o número da conta:");
                            numeroDaConta = scan.nextInt();
                            scan.nextLine();
                            ...
                            ContaSimples contaSimples = new ContaSimples(numeroDaConta, agencia, senha, ativa, saldo,pessoaJuridica);
