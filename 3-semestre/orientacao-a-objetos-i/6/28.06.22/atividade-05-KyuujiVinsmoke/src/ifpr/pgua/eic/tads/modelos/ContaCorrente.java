...
public class ContaCorrente
{
    ...
    public ContaCorrente(int numeroDaConta, int agencia,Pessoa pessoa, String senha, boolean ativa, double saldo)
    {
    ...
    public ContaCorrente(int numeroDaConta, int agencia, Pessoa pessoa,String senha, boolean ativa)
    {
