...
public class JanelaMatricularAlunos implements Initializable 
{
    @FXML
    ...
    public JanelaMatricularAlunos(Escola escola)
    {
        this.escola = escola;
    }
    ...
    private void matricularAluno(ActionEvent evento)
    {
        ...
        else if(!escola.matricularAluno(curso, aluno))
        {
            Alert alert = new Alert(AlertType.WARNING, "Aluno Já Matriculado No Curso!");
            alert.showAndWait();
            return;
        }
